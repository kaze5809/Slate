...
<head>
    ...
    Although forced in htaccess so not really needed
    ==================================================  -->
   ...
   <header>
    ...
    <div class="container">
        ...
        <article class="row">
                ...
                <aside class="one-third column">
                    <h6>A bit more...<br>Aside Info</h6>
                    <hr>
                    <p>Nullam lobortis lacus eu nisi pretium et pellentesque lorem dapibus. Nulla facilisi. Donec eu odio nec elit tincidunt pharetra. Donec a interdum magna. Integer vestibulum nisi sed metus pulvinar viverra.</p>
                </aside>
     ...
     <!--<article class="row">  
                ...
                <section class="two-thirds column">
                    ...
                    <div class="one-third column alpha">
                    	<h1><i class="icon-youtube"></i></h1>
                    </div>
                    <div class="one-third column">
                    	<h1><i class="icon-play-1"></i></h1>
                    </div>
                    <div class="one-third column omega">
                    	<h1><i class="icon-cancel-squared"></i></h1>
                    </div>
                    
                    <div class="one-third column alpha">
                    	<h1><i class="icon-eye"></i></h1>
                    </div>
                    <div class="one-third column">
                    	<h1><i class="icon-left-open"></i></h1>
                    </div>
                    <div class="one-third column omega">
                    	<h1><i class="icon-right-open"></i></h1>
                    </div>
        ...
        <article class="row">
                ...
                <section class="six columns">
                        ...
                        <form class="nice" action="">
                            ...
                            <input type="search" class="input-text" name="search">
                            <input type="submit">
                        </form>
                        ...
                        <form class="nice" action="">
                            ...
                            <input type="text" class="input-text" name="Forename" placeholder="Forename"/>
                            
                            
                            <label for="Surname">Surname</label>
                            <input type="text" class="input-text" name="Surname" placeholder="Surname" autofocus />
                            ...
                            <input type="email" class="input-text" name="email" placeholder="email@email.com"  required />
                            ...
                            <input type="url" class="input-text"name="url" placeholder="url"/>
                             
                             <!-- Label and text input
                            <label for="number">number</label>
                             <input type="number" min="5" max="18" step="0.5" value="9" pattern="[0-9]*" name="shoe-size"> --> <!--
         ...
         <article class="row">
                ...
                <aside class="one-third column">
                    ...
                    <map name="egmap">
                         <a href="sk-dynamics.html"><area shape="rect" coords="2,-4,84,79" href="#" alt="Example Map" /></a>
                    </map>
                    
                    <blockquote>"test quote"<cite>"test quote"</cite></blockquote>
                </aside>
